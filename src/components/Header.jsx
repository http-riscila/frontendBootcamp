      ...
      <header className="mx-auto grid min-h-[100px] max-w-[1240px] grid-cols-12 items-center">
        ...
        <div className="col-span-9 flex items-center justify-end gap-3">
          <nav className="flex justify-end gap-7 pr-8">
            <Link
              to="/home"
              className={`group flex items-center gap-2 font-medium ${location.pathname === "/home" ? "text-[var(--color-primary)]" : "text-[var(--color-title)]"} hover:text-[var(--color-primary)]`}
            >
              <svg
                className={`h-6 w-6 ${
            ...
            <Link
              to="/comunidades"
              className={`group flex items-center gap-2 ${location.pathname === "/comunidades" ? "text-[var(--color-primary)]" : "text-[var(--color-title)]"} hover:text-[var(--color-primary)]`}
            >
              <svg
                className={`h-6 w-6 ${location.pathname === "/comunidades" ? "text-[var(--color-primary)]" : "text-[var(--color-title)]"} group-hover:text-[var(--color-primary)]`}
                viewBox="0 0 26 26"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
                  d="M14 8C14 10.7614 11.7614 13 9 13C6.23858 13 4 10.7614 4 8C4 5.23858 6.23858 3 9 3C11.7614 3 14 5.23858 14 8Z"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
                <path
                  d="M17 23V23C17 19.6863 14.3137 17 11 17H8C4.68629 17 2 19.6863 2 23V23"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
                <path
                  d="M13 4.09664C13.8428 3.41045 14.9127 3 16.0769 3C18.7959 3 21 5.23858 21 8C21 10.7614 18.7959 13 16.0769 13C14.9127 13 13.8428 12.5896 13 11.9034"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
                <path
                  d="M23 23V23C23 19.6863 20.3137 17 17 17H10"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
            ...
            <Link
              to="/como-funciona"
              className={`group flex items-center gap-2 ${location.pathname === "/como-funciona" ? "text-[var(--color-primary)]" : "text-[var(--color-title)]"} hover:text-[var(--color-primary)]`}
            >
              <svg
                width="22"
                height="22"
