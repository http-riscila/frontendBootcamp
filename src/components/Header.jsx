      ...
      <header className="mx-auto grid min-h-[100px] max-w-[1240px] grid-cols-12 items-center">
        ...
        <div className="col-span-9 flex items-center justify-end gap-3">
          <nav className="flex justify-end gap-7 pr-8">
            <a
              href="#"
              className="flex items-center gap-2 font-medium text-[#1B5FFF]"
            >
              <svg
            ...
            <a
              href="#"
              className="group flex items-center gap-2 text-[#111827] hover:text-[#1B5FFF]"
            >
              <svg
                className="h-6 w-6 text-[#111827] group-hover:text-[#1B5FFF]"
                viewBox="0 0 26 26"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <Button
            ...
            size="lg"
            outlineColor="#1B5FFF"
            className="cursor-pointer text-[#1B5FFF] hover:bg-[#1B5FFF] hover:text-white"
          >
            Entrar
          </Button>
          <Button
            size="lg"
            className="cursor-pointer text-white hover:bg-blue-700 hover:text-white"
          >
            Quero Trocar
          </Button>
        </div>
