export default function Footer() {
  return (
    <footer className="w-full bg-[#1a202c] py-12 text-gray-300 md:py-16 lg:py-20">
      <div className="mx-auto grid max-w-[1240px] gap-20 px-10 sm:px-6 md:grid-cols-2 md:px-12 lg:grid-cols-12 lg:px-[0]">
        ...
        <div className="col-span-8 flex items-center justify-end gap-20">
          ...
          <div className="gap-20 space-y-4 text-sm lg:col-span-3">
      ...
      <div className="mx-auto mt-8 flex max-w-[1240px] flex-col items-center justify-between gap-4 border-t border-gray-700 px-4 pt-8 text-gray-400 sm:px-6 md:flex-row md:px-12 lg:px-[100px] lg:pr-[0] lg:pl-[0]">
